...
import { socketInit, sendDirectMessage, createGroup, sendMessageInRoom } from "../../services/websocket.js";
...
function Chat({ loginData }) {
    ...
    }, [messages, searchResult, usersAndRoom,loginData]);
    //   useEffect(()=>{
        ...
        <div className={styles.container}>
            ...
            <div className={styles.main}>
                <div className={styles.messages}>
                    {selectedUser && messages?.[selectedUser.roomName ? 'room' : 'direct'][selectedUser.roomName ?? selectedUser.email]?.map((msg, index) => (
